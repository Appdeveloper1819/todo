    ...
    <>
      <nav className="bg-gray-300 dark:bg-gray-900 shadow flex flex-row px-12 py-2 items-center justify-between sticky top-0 z-10">
        ...
        <div className="flex space-x-2 items-center">
          <i
            className="material-symbols-rounded text-gray-600 dark:text-white text-lg sm:text-2xl cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-700 p-2 rounded-lg sm:hidden"
          ...
          <i
            className={`material-symbols-rounded text-gray-600 dark:text-white text-lg sm:text-2xl cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-700 p-2 rounded-full ${isprogress ? "animate-spin" : ""}`}
      ...
      {showSearch && (
        <div className="fixed top-2 left-10 right-2 bg-gray-100 dark:bg-gray-900 p-2 rounded-lg shadow-md flex items-center z-20">
          <i
